// src/lib/ai/providers/AnthropicProvider.js
//
...
// implementation when the business decides to enable Anthropic -- no
// caller of AIService needs to change when that happens.

import { createDisabledProvider } from "./disabledProvider";

export default createDisabledProvider("anthropic");
